...
def get_graduated_complexity_mapping(
    analysis: RequirementAnalysis, primary_pattern: PatternType
) -> Dict[str, Any]:
    """
...
def enhance_pattern_mapping(
    mapping: Dict[str, Any], pattern: PatternType, analysis: RequirementAnalysis
):
