...
Examples:
  ...
  %(prog)s --workspace /tmp   # Use custom workspace directory
    ...
    parser.add_argument(
        "-w", "--workspace", help="Specify custom test workspace directory"
    )
    ...
    try:
        ...
        print(
            "🚀 Starting End-to-End Test Scenarios for Universal PocketFlow Integration"
        )
        print("=" * 80)
        print()
        ...
        print()
        print(
            "Make sure you're running this script from the framework-tools directory."
        )
