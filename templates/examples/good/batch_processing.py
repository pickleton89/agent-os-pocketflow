...
class AsyncDocumentProcessor(AsyncParallelBatchNode):
    ...
    async def _process_document_async(self, document: Dict[str, Any]) -> Dict[str, Any]:
        ...
        enhanced_doc = {
            ...
            "async_metadata": {"processing_time": "0.1s", "enhanced": True},
        }
...
if __name__ == "__main__":
    ...
    shared = SharedStore({"documents": sample_documents, "batch_size": 2})
    ...
    async def test_async():
        ...
        shared_async = SharedStore({"documents": sample_documents, "max_concurrent": 3})
        ...
        print(
            f"Async processed {len(shared_async['async_processed_documents'])} documents"
        )
