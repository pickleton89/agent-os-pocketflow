    ...
    def exec(self, prep_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for field, expected_type in type_rules.items():
            if field in input_data:
                ...
                elif expected_type == 'email' and not self._is_valid_email(actual_value):
    ...
    def exec_fallback(self, prep_result: Dict[str, Any], exception: Exception) -> Dict[str, Any]:
        ...
        self.logger.error(
            ...
            extra={
                ...
                'input_data_keys': list(prep_result['input_data'].keys()) if prep_result['input_data'] else []
            }
        )
        
        return error_info
    
    def post_fallback(self, shared: SharedStore, prep_result: Dict[str, Any], fallback_result: Dict[str, Any]) -> str:
        """
...
class ExternalAPINode(AsyncNode):
    ...
    def exec_fallback(self, prep_result: Dict[str, Any], exception: Exception) -> Dict[str, Any]:
        ...
        should_retry = self._should_retry(error_type, prep_result['attempt_count'], prep_result['max_retries'])
        ...
        if should_retry:
            ...
            self.logger.error(
                ...
                extra={'error_type': error_type, 'url': prep_result['api_url'], 'attempts': error_info['attempt_count']}
            )
    ...
    def _should_retry(self, error_type: str, attempt_count: int, max_retries: int) -> bool:
...
class ErrorRecoveryNode(Node):
    ...
    def exec(self, prep_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if validation_error:
            ...
            fallback_data = self._apply_validation_fallback(original_data, validation_error)
    ...
    def _apply_validation_fallback(self, original_data: Dict[str, Any], error_info: Dict[str, Any]) -> Dict[str, Any]:
