...
from baselineworkflowworkflow.flow import BaselineWORKFLOWWorkflowFlow


class TestBaselineWORKFLOWWorkflowFlow:
    """Tests for BaselineWORKFLOWWorkflowFlow."""

    @pytest.fixture
    def flow(self):
        return BaselineWORKFLOWWorkflowFlow()
