...
from baselineagentworkflow.flow import BaselineAGENTWorkflowFlow


class TestBaselineAGENTWorkflowFlow:
    """Tests for BaselineAGENTWorkflowFlow."""

    @pytest.fixture
    def flow(self):
        return BaselineAGENTWorkflowFlow()
