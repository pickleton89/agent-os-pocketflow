...
from baselineragworkflow.flow import BaselineRAGWorkflowFlow


class TestBaselineRAGWorkflowFlow:
    """Tests for BaselineRAGWorkflowFlow."""

    @pytest.fixture
    def flow(self):
        return BaselineRAGWorkflowFlow()
