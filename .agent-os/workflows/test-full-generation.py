...
def test_file_contents():
    ...
    if nodes_file.exists():
        ...
        expected_classes = ["DocumentRetrieverNode", "ContextBuilderNode", "LLMAnalyzerNode", "ResponseFormatterNode"]
        ...
        if len(found_classes) == len(expected_classes):
            ...
            print(f"  ✗ Missing node classes: {set(expected_classes) - set(found_classes)}")
            return False
