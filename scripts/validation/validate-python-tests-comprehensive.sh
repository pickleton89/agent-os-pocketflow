...
main() {
  ...
  run_py "full generation + deps" python3 pocketflow-tools/test_full_generation_with_dependencies.py

  # Dependency orchestrator comprehensive suite
  run_py "dependency orchestrator comprehensive" python3 pocketflow-tools/test_dependency_orchestrator.py
