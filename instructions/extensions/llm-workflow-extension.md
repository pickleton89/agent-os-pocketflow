    ...
    def get_pattern_guidance(self, pattern: PocketFlowPattern) -> Dict[str, Any]:
        ...
        guidance = {
            PocketFlowPattern.AGENT: {
                ...
                "typical_flow": "Input → Analyze → Decide → Execute → Learn"
            },
            PocketFlowPattern.WORKFLOW: {
                ...
                "typical_flow": "Input → Prepare → Process → Validate → Output"
            },
            PocketFlowPattern.RAG: {
                ...
                "typical_flow": "Query → Retrieve → Augment → Generate → Respond"
            },
            PocketFlowPattern.MAPREDUCE: {
                ...
                "typical_flow": "Input → Partition → Map → Reduce → Aggregate"
            },
            PocketFlowPattern.MULTI_AGENT: {
                ...
                "typical_flow": "Coordinate → Distribute → Execute → Communicate → Aggregate"
            }
        }
...
invoke_llm_orchestrator() {
    ...
    echo "🤖 Invoking PocketFlow orchestrator for LLM task: $task"
